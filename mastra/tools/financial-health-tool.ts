...
// Input schema for financial profile data
...
const FinancialHealthReportSchema = z.object({
...
export const financialHealthTool = createTool({
  id: 'generate-financial-health-report',
  description:
  ...
  outputSchema: FinancialHealthReportSchema,
  execute: async ({ context }) => {
    return generateFinancialHealthReport(context.profile);
  },
});
